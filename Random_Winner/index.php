<?php include '../conexion.php'; 
 ...
 $sql2 ="SELECT * FROM invitados_participando_actualizada WHERE id=$rand";
...
<div class="marco">
    <div class="row">
        ...
        <div class="col col-md-12">
        <div class="botones">
    <button class="boton" id="demo" ><a class="nav-link" href="../Seleccion_Premio/index.php">Siguiente<a></button>
    <p id="random"></p>
</div>
